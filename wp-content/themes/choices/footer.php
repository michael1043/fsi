...
#### -->
		...
		$kriesi_at_backlink =	apply_filters("kriesi_backlink", " - Design by <a href='http://www.wikmag.com/choices-responsive-theme.html' target='_blank'>Kriesi</a>");
		?>
		
		<!-- ####### SOCKET CONTAINER ####### -->
			<div class='container_wrap socket_color' id='socket'>
				<div class='container'>
					<span class='copyright'><?php _e('Copyright','avia_framework'); ?> &copy; <?php echo date('Y'); ?> <a href='<?php echo home_url('/'); ?>'><?php echo get_bloginfo('name');?></a> </span>
