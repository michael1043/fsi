...
$key .button:hover, $key .ajax_controlls a:hover, $key #submit:hover, $key .big_button:hover, $key .contentSlideControlls a:hover{
...
$key .iconbox_top, #top $key.thumbnails_container_wrap, $key .portfolio-sort-container .inner-entry, $key .pullquote_boxed{
background: $bg2;
}
...
$key .portfolio-sort-container .inner-entry:hover h1, $key .portfolio-sort-container .inner-entry:hover p{
color:#fff;
}
...
#top $key.title_container .main-title, #top $key.title_container .main-title a, $key .slideshow li{
color:$color;
}
...
$key .main_menu ul:first-child > li a:hover, $key .main_menu ul:first-child > li.current-menu-item > a,  $key .main_menu ul:first-child > li.current_page_item > a{
color:$meta;
}
";
...
";
	...
	switch($key)
	{
		...
		$output .= " 
			...
			#info_text_header { background-color: $primary;  color:#fff;}
